...
| 5 | Training | RET2 Systems Wargames | [RET2 Wargames](https://wargames.ret2.systems/) <br> [RET2 Wargames (Review)](https://www.linkedin.com/pulse/ret2-systems-wargames-review-milton-valencia-0udrf/) |
...
| 1 | Open Source Training | Reverse engineering the _SECURITY_DESCRIPTOR | [My Analysis (TODO)](https://wetw0rk.github.io/) <br> [Kernel ACE Edit Shellcode (Sickle Module)](https://github.com/wetw0rk/Sickle/blob/master/src/sickle/payloads/windows/x64/kernel_ace_edit.py) |
| 2 | Open Source Training | Leverage knowledge from RET2 to exploit CVE-2018-0617 | [My Analysis (TODO)](https://wetw0rk.github.io/) |
| 3 | Open Source Training | Writing shellcode with Sickle | [Tutorial (TODO)]() <br> [Sickle Project](https://github.com/wetw0rk/Sickle) |
